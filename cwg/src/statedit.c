...
int stats_disp_menu(struct descriptor_data *d)
{
  send_to_char(d->character,
    ...
    " <| @BS@W) @nStrength     : @W%3d     |>     assign all the points, you will lose them forever.\r\n"
    " <| @BD@W) @nDexterity    : @W%3d     |>     If your points are at zero, you may still reassign\r\n"
    " <| @BN@W) @nConstitution : @W%3d     |>     points by lowering any statistic, then add those\r\n"
    " <| @BI@W) @nIntelligence : @W%3d     |>     points to the statistic of your choice.\r\n"
    " <| @BW@W) @nWisdom       : @W%3d     |>\r\n"
    " <| @BC@W) @nCharisma     : @W%3d     |>\r\n"
    " <| @BQ@W) @nQuit@W                   |>\r\n"
    "-<[@y===========================@W]>-@n\r\n"

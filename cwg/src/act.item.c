...
void wear_message(struct char_data *ch, struct obj_data *obj, int where)
{
  const char *wear_messages[][2] = {
    ...
    //"A $p begins to float above your head."},
    ...
    {"$n slides $p on $s left finger.",
    "You slide $p on your left finger."},

    {"$n slides $p on $s right finger.",
    "You slide $p on your right finger."},
    ...
    {"$n carries $p on $s back.",
    "You now carry $p on your back."},

    {"$n wears $p across $s back.",
    "You wear $p across your back."}
  };
...
*/
  ...
  // New bit vectors and order.
  int wear_bitvectors[] = {
    ITEM_WEAR_TAKE, ITEM_WEAR_HEAD, ITEM_WEAR_FACE,
    ITEM_WEAR_NOSE, ITEM_WEAR_EAR, ITEM_WEAR_EAR, ITEM_WEAR_NECK,
    ITEM_WEAR_NECK, ITEM_WEAR_SHOULDERS, ITEM_WEAR_BODY, ITEM_WEAR_ABOUT,
    ITEM_WEAR_ARMS, ITEM_WEAR_WRIST, ITEM_WEAR_WRIST, ITEM_WEAR_HANDS,
    ITEM_WEAR_FINGER, ITEM_WEAR_FINGER, ITEM_WEAR_WIELD, ITEM_WEAR_SHIELD,
    ITEM_WEAR_HOLD, ITEM_WEAR_WAIST, ITEM_WEAR_WAIST, ITEM_WEAR_HANG,
    ITEM_WEAR_LEGS, ITEM_WEAR_ANKLE, ITEM_WEAR_ANKLE, ITEM_WEAR_FEET,
    ITEM_WEAR_ONBACK, ITEM_WEAR_BACK
  };
...
// New error messages and order.
  const char *already_wearing[] = {
    ...
    "You are already wearing something in your nose.\r\n",
    "You are already wearing something in both ears.\r\n",
    "You are already wearing something in both ears.\r\n",
    ...
    "You cannot wear anything else around your wrists.\r\n",
    "You cannot wear anything else around your wrists.\r\n",
    "You are already wearing something on your hands.\r\n",
    "You cannot wear anything else on your fingers.\r\n",
    "You cannot wear anything else on your fingers.\r\n",
    "You are already wielding a weapon.\r\n",
    "You are already holding something.\r\n",
    "You cannot wear anything else about your waist.\r\n",
    "You cannot wear anything else about your waist.\r\n",
    "There is something already hanging from your belt.\r\n",
    "You are already wearing something on your legs.\r\n",
    "You cannot wear anything else around your ankles.\r\n",
    "You cannot wear anything else around your ankles.\r\n",
    "You are already wearing something on your feet.\r\n",
    "You cannot carry anything else on your back.\r\n",
  ...
  // Commented out to remove handicap for equipping a light.
  if ((//(where == WEAR_LIGHT)  ||
       (where == WEAR_SHIELD) ||
       (where == WEAR_WIELD)  ||
...
/*
  const char *keywords[] = {
    "!RESERVED!",   // Light.
    "finger",
    "!RESERVED!",   // Second finger.
    "neck",
    "!RESERVED!",   // Second neck.
    "body",
    "head",
    "legs",
    "feet",
    ...
    "waist",
    "wrist",
    "!RESERVED!",   // Second wrist.
    "!RESERVED!",   // Wield.
    "!RESERVED!",   // Hold.
    "back",
    "ear",
    "\r!RESERVED!", // Second ear.
    "wing",
    "mask",
    "\n"
  };
*/
  ...
  const char *keywords[] = {
    ...
    "!RESERVED!",   // Hold.
    "waist",
    "!RESERVED!",   // Second waist.
    "hang",   // Hanging from belt.
    "legs",
    "ankle",
    "!RESERVED!",   // Second ankle.
    "feet",
    "onback",
    "back"
...
*/
  if(!arg || !*arg) {
    ...
    if (CAN_WEAR(obj, ITEM_WEAR_EAR))            where = WEAR_EAR_R;
    if (CAN_WEAR(obj, ITEM_WEAR_NECK))           where = WEAR_NECK_1;
    if (CAN_WEAR(obj, ITEM_WEAR_SHOULDERS))      where = WEAR_SHOULDERS;
    if (CAN_WEAR(obj, ITEM_WEAR_BODY))           where = WEAR_BODY;
    if (CAN_WEAR(obj, ITEM_WEAR_ABOUT))          where = WEAR_ABOUT;
    if (CAN_WEAR(obj, ITEM_WEAR_ARMS))           where = WEAR_ARMS;
    if (CAN_WEAR(obj, ITEM_WEAR_WRIST))          where = WEAR_WRIST_R;
    ...
    if (CAN_WEAR(obj, ITEM_WEAR_FEET))           where = WEAR_FEET;
    if (CAN_WEAR(obj, ITEM_WEAR_ONBACK))         where = WEAR_ONBACK;
...
// Here is the level restriction for wearing gear.
// Line 1677.
ACMD(do_wear)
{
  char arg1[MAX_INPUT_LENGTH];

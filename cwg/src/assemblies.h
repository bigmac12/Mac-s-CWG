...
#define ASSM_MAKE              101       // Assembly must be made.
#define ASSM_BREW              102       // Assembly must be brewed.
#define ASSM_BAKE              103       // Assembly must be baked.
#define ASSM_ASSEMBLE          104       // Assembly must be assembled.
#define ASSM_CRAFT             105       // Assembly must be crafted.
#define ASSM_FLETCH            106       // Assembly must be fletched.
#define ASSM_KNIT              107       // Assembly must be knitted.

...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "affect"   , "aff"	, POS_DEAD    , do_affect   , 0, 0 },
  ...
  { "chown"    , "cho"  , POS_DEAD    , do_chown    , LVL_GRGOD, 0 },
  ...
  { "finddoor" , "findd", POS_SLEEPING, do_finddoor , LVL_IMMORT, 0 },
  { "findkey"  , "findk", POS_SLEEPING, do_findkey  , LVL_IMMORT, 0 },
  ...
  { "ooc"      , "ooc"	, POS_RESTING , do_ooc      , 0, 0 },
  ...
  { "pose"     , "pose"	, POS_RESTING , do_pose      , 0, 0 },
  ...
  { "skillcheck" , "skillc"	, POS_DEAD    , do_skillcheck, LVL_IMMORT, 0 },
  ...
  { "zpurge"   , "zpurge"       , POS_DEAD    , do_zpurge   , LVL_GRGOD, 0 }, 
...
void nanny(struct descriptor_data *d, char *arg)
{
  ...
  case CON_NAME_CNFRM:		/* wait for conf. of new name    */
	...
	return;
      ...
      if (circle_restrict) {
	write_to_output(d, "Sorry, new characters can't be created at this time.\r\n");
  ...
  case CON_QSEX:		/* query sex of new user         */
    ...
    case 'F':
      ...
      break;
    default:
      write_to_output(d, "That is not a gender.\r\n"
		"What IS your sex? ");
      return;
    }
  ...
  case CON_QROLLSTATS:
    ...
    write_to_output(d, "%s\r\n*** PRESS RETURN: ", motd);
    STATE(d) = CON_RMOTD;
    mudlog(CMP, LVL_GOD, TRUE, "New player: %s [%s %s]",
           GET_NAME(d->character), pc_race_types[GET_RACE(d->character)],
           pc_class_types[GET_CLASS(d->character)]);
    mudlog(CMP, LVL_GOD, TRUE, "Str: %2d Dex: %2d Con: %2d Int: %2d "
           "Wis:  %2d Cha: %2d", GET_STR(d->character),
  ...
  case CON_MENU: {		/* get selection from main menu  */
	...
	send_to_char(d->character, "\r\n\007You could not afford your rent!\r\n"
		"Your possesions have been sold to cover the costs!\r\n");
      }
      d->has_prompt = 0;

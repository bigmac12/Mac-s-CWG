...
int class_ok_race[NUM_RACES][NUM_CLASSES] = {
  /*                 M, C, T, W, Kn, Pa, Dr, Ra, Df, Dk */
  /* Human      */ { Y, Y, Y, Y, Y,  Y,  Y,  Y,  N,  Y },
  /* Elf        */ { Y, Y, Y, Y, N,  Y,  Y,  Y,  N,  N },
  /* Gnome      */ { Y, Y, Y, Y, N,  N,  N,  N,  N,  N },
  /* Dwarf      */ { N, Y, Y, Y, N,  Y,  N,  N,  Y,  N }
};
...
int parse_class(struct char_data *ch, int arg)
{
  ...
  case 5: class = CLASS_KNIGHT; break;
  case 6: class = CLASS_PALADIN; break;
  case 7: class = CLASS_DRUID; break;
  case 8: class = CLASS_RANGER; break;
  case 9: class = CLASS_DEFENDER; break;
  case 99: class = CLASS_DEATH_KNIGHT; break;
...
/* Thief 	*/ { 13, 18, 13, 16, 10, 10 },
/* Warrior 	*/ { 18, 13, 16, 10, 13, 10 }
};

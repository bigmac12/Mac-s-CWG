...
0 d 100
yes~
@B * This is just a check to see if the mob is carrying an item, put it in there
* so that only one version of the mob responds.@n
if %self.has_item(2763)
  wait 1 s
@B * The mob loads the item and gives it to the person saying "yes".@n
  %load% obj 2768
